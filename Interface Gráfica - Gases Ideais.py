...
def EquacaoDeClapyronCalculo_N(tfP_N, tfV_N, tfN_N, lbrk, tfT_N, uP, uV):
    ...
    if len(tfP_N.get()) == 0 and len(tfV_N.get()) == 0 and len(tfN_N.get()) == 0 and len(tfT_N.get()) == 0:
        ...
        if len(tfP_N.get()) == 0 or len(tfV_N.get()) == 0 or len(tfT_N.get()) == 0:
            ...
            frToolBarBottom.grid(row = 2, column = 0, sticky = W+E)
            frToolBarBottom.config(bg = "green")
            lbnDesejado = Label(frToolBarBottom, text = "N = "+str(N)+" particulas", bg = "green", width = 40)
            lbnDesejado.grid(row = 0, column = 0)
            frToolBarBottom.columnconfigure(0, weight = 1)
            frToolBarBottom.rowconfigure(0, weight = 1)
    elif len(tfT_N.get()) == 0:
    ...
    if parametro == "Pa" or parametro == "atm" or parametro == "mmHg":
        if parametro == "Pa":
            ...
            if aux_mudar_constante[1] == "m^3":
                lbrk["text"] = "1.38x10^-23 Pa.m^3.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "L":
                lbrk["text"] = "1.38x10^-20 Pa.L.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "mL":
                lbrk["text"] = "1.38x10^-17 Pa.mL.K^-1.particula^-1"

        elif parametro == "atm":
            aux_mudar_constante[0] = "atm"
            if aux_mudar_constante[1] == "m^3":
                lbrk["text"] = "1.36x10^-28 atm.m^3.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "L":
                lbrk["text"] = "1.36x10^-25 atm.L.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "mL":
                lbrk["text"] = "1.36x10^-22 atm.mL.K^-1.particula^-1"
        
        elif parametro == "mmHg":
            aux_mudar_constante[0] = "mmHg"
            if aux_mudar_constante[1] == "m^3":
                lbrk["text"] = "1.03x10^-25 mmHg.m^3.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "L":
                lbrk["text"] = "1.03x10^-22 mmHg.L.K^-1.particula^-1"
            elif aux_mudar_constante[1] == "mL":
                lbrk["text"] = "1.03x10^-19 mmHg.mL.K^-1.particula^-1"
...
lbUnidades = Label(frTransfIsov, text = "Selecione as unidades da entrada")
lbP = Label(frTransfIsov, text = "Pressão")
mnP = OptionMenu(frTransfIsov, tkP, *escolhasP)
mnP.config(width = 18)
lbT = Label(frTransfIsov, text = "Temperatura")
mnT = OptionMenu(frTransfIsov, tkT, *escolhasT)
mnT.config(width = 18)

btCalcularIsovolumetrica = Button(frTransfIsov, text = "Calcular", width = 18)
...
lbUnidades = Label(frTransfIsob, text = "Selecione as unidades da entrada")
lbV = Label(frTransfIsob, text = "Volume")
mnV = OptionMenu(frTransfIsob, tkV, *escolhasV)
mnV.config(width = 18)
lbT = Label(frTransfIsob, text = "Temperatura")
mnT = OptionMenu(frTransfIsob, tkT, *escolhasT)
mnT.config(width = 18)

btCalcularIsobarica = Button(frTransfIsob, text = "Calcular", width = 18)
...
lbUnidades = Label(frTransfIsot, text = "Selecione as unidades da entrada")
lbP = Label(frTransfIsot, text = "Pressão")
...
btCalcularIsotermica = Button(frTransfIsot, text = "Calcular", width = 18)
...
lbNa_Na = Label(frEqClapeyron_Na, text = "Número de Avogadro")
...
escolhasNa = {"Partícula(s)"}
tkN_Na.set("Partícula(s)")

tkT_Na = StringVar(frEqClapeyron_Na)
escolhasT_Na = {"K"}
tkT_Na.set("K")

lbUnidades_Na = Label(frEqClapeyron_Na, text = "Selecione as unidades da entrada")

lbPU_Na = Label(frEqClapeyron_Na, text = "Pressão")
...
lbNU_Na = Label(frEqClapeyron_Na, text = "Partículas")
...
lbTU_Na = Label(frEqClapeyron_Na, text = "Temperatura")
mnT_Na = OptionMenu(frEqClapeyron_Na, tkT_Na, *escolhasT_Na)
mnT_Na.config(width = 18)

btCalcularClapeyron_Na = Button(frEqClapeyron_Na, text = "Calcular", width = 18)
...
escolhasN = {"Partícula(s)"}
tkN_N.set("Partícula(s)")

tkT_N = StringVar(frEqClapeyron_N)
escolhasT_N = {"K"}
tkT_N.set("K")

lbUnidades_N = Label(frEqClapeyron_N, text = "Selecione as unidades da entrada")

lbPU_N = Label(frEqClapeyron_N, text = "Pressão")
...
lbNU_N = Label(frEqClapeyron_N, text = "Partículas")
mnN_N = OptionMenu(frEqClapeyron_N, tkN_N, *escolhasN)
mnN_N.config(width = 18)

lbkU = Label(frEqClapeyron_N, text = "k")
lbrk = Label(frEqClapeyron_N, text = "1.38x10^-23 Pa.m^3.K^-1.particula^-1")

lbTU_N = Label(frEqClapeyron_N, text = "Temperatura")
mnT_N = OptionMenu(frEqClapeyron_N, tkT_N, *escolhasT_N)
mnT_N.config(width = 18)

btCalcularClapeyron_N = Button(frEqClapeyron_N, text = "Calcular", width = 18)
...
lbUnidades_M = Label(frEqClapeyron_M, text = "Selecione as unidades da entrada")
lbPU_M = Label(frEqClapeyron_M, text = "Pressão")
...
lbmU_M = Label(frEqClapeyron_M, text = "Massa")
mnm_M = OptionMenu(frEqClapeyron_M, tkm_M, *escolhasm)
mnm_M.config(width = 18)
lbMU_M = Label(frEqClapeyron_M, text = "Massa molar")
mnM_M = OptionMenu(frEqClapeyron_M, tkM_M, *escolhasM)
mnM_M.config(width = 18)
lbrR_M = Label(frEqClapeyron_M, text = "8.31 J.K^-1.mol^-1")
lbTU_M = Label(frEqClapeyron_M, text = "Temperatura")
mnT_M = OptionMenu(frEqClapeyron_M, tkT_M, *escolhasT_M)
mnT_M.config(width = 18)

btCalcularClapeyron_M = Button(frEqClapeyron_M, text = "Calcular", width = 18)
...
lbUnidades = Label(frEqGeral, text = "Selecione as unidades da entrada")
lbP = Label(frEqGeral, text = "Pressão")
mnP = OptionMenu(frEqGeral, tkP, *escolhasP)
mnP.config(width = 18)
lbV = Label(frEqGeral, text = "Volume")
mnV = OptionMenu(frEqGeral, tkV, *escolhasV)
mnV.config(width = 18)
lbT = Label(frEqGeral, text = "Temperatura")
mnT = OptionMenu(frEqGeral, tkT, *escolhasT)
mnT.config(width = 18)

btCalcular = Button(frEqGeral, text = "Calcular", width = 18)
...
btEqGeral = Button(frToolBar, text = "Equação geral dos gases", width = 25, command = EquacaoGeralDosGases)
btBoyle = Button(frToolBar, text = "Transformação isotérmica", width = 25, command = TransformacaoIsotermica)
btCharles = Button(frToolBar, text = "Transformação isobárica", width = 25, command = TransformacaoIsobarica)
btCharlesGayLussac = Button(frToolBar, text = "Transformação isovolumétrica", width = 25, command = TransformacaoIsovolumetrica)
btDensidade = Button(frToolBar, text = "Densidade do gás d = PM/RT", width = 25, command = DensidadeGas)
